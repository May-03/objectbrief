...
<AffiliateProductCard
  ...
  label="Visible tamper evidence"
  description="A previously screened low-MOQ perforated shrink-band option for bottle/jar tamper-evident trials."
  features={JSON.parse('["Best for: tamper-evidence trials (approx. 100 pc MOQ)", "Format: perforated external neck band", "MOQ / price: recheck the live listing before ordering"]')}
...
<AffiliateProductCard
  title="Customized 35/38mm Induction Seal Liners for Glass Bottle Caps & Jars"
  label="Inner seal path"
  description="A customizable induction seal liner — the Alibaba page states MOQ 1,000 pieces, customizable diameter, and 1–5 sample pieces."
  features={JSON.parse('["Best for: inner seals with custom diameters", "Specs: 35/38mm and other custom sizes; MOQ 1,000 pc, samples available", "Confirm: intended container/material compatibility before order"]')}
  moq="MOQ 1,000 pc (1–5 sample pieces)"
...
<AffiliateProductCard
  title="Plastic Screw Caps with Food-Grade PE/PET Heat-Induction Seal Liners (20–32mm)"
  label="Integrated closure"
  description="A cap/closure listing with a heat-induction liner for common cosmetic/food bottle sizes — the path where the liner arrives already integrated in the cap."
  features={JSON.parse('["Best for: buying cap + liner as one closure", "Specs: food-grade PE/PET liners, 20–32mm sizes; MOQ shown: 500 pc", "Confirm: liner construction and exact container compatibility"]')}
  moq="MOQ shown: 500 pc"
  affiliateUrl="https://offer.alibaba.com/cps/qecacded?bm=cps&src=saf&productId=62498146139"
  buttonText="Check Price & MOQ on Alibaba"
/>
/>
...
<AffiliateEndCta
  prompt="Looking for a sealing supplier?"
