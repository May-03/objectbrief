...
| --- | --- | --- |
| Low-MOQ application test | perforated neck-band listing previously screened for small-batch testing; current project snapshot: MOQ around 100 pieces. Useful for validating fit and operator technique before a larger order. | [Check current Alibaba offer &rarr;](https://offer.alibaba.com/cps/qecacded?bm=cps&src=saf&productId=1600874115983) |
| PVC perforated baseline | PVC heat-shrink seal band for bottles/jars with an easy-tear perforation; current project snapshot: MOQ around 1,000 pieces. Useful as a conventional PVC neck-band reference. | [Check current Alibaba offer &rarr;](https://offer.alibaba.com/cps/qecacded?bm=cps&src=saf&productId=1601070829087) |
| Custom size / material path | custom PVC/PETG clear neck shrink-band listing; current project snapshot: MOQ around 1,000 pieces. Relevant when repeated wrinkles point to a need for a better-matched size or film rather than more heat. | [Check current Alibaba offer &rarr;](https://offer.alibaba.com/cps/qecacded?bm=cps&src=saf&productId=1600555060434) |
